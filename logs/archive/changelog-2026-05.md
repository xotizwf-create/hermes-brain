# Changelog archive — 2026-05 (bootstrap era)

Rotated out of `../changelog.md` on 2026-06-13 to keep the live log lean.
These are the brain's first-month bootstrap entries (built 2026-05-29).
Newest on top, same format as the live changelog.
